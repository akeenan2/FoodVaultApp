...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        String CREATE_RECIPES_TABLE = "CREATE TABLE " + TABLE_RECIPES + "(" + KEY_ID
                ...
                + KEY_PREPTIME + " TEXT," + KEY_INGREDIENTS + " TEXT," + KEY_RATING + " TEXT,"
                + KEY_COMMENTS + " TEXT" + ");";
    ...
    Recipe getRecipe(int id){
        ...
        Cursor cursor = db.query(TABLE_RECIPES, new String[] { KEY_ID, KEY_NAME, KEY_URL,
                        KEY_PREPTIME, KEY_INGREDIENTS,KEY_RATING, KEY_COMMENTS},
    ...
    public List<Recipe> getAllRecipes(){
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                recipe.setRating(cursor.getString(5));
                recipe.setComments(cursor.getString(6));
